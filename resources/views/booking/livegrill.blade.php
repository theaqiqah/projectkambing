        ...
        <div class="row">
            <div class="col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2 col-lg-6 col-lg-offset-3 form-box">
                <form role="form" action="/" method="post" class="f1">
                    ...
                    <h2 class="title">Form Livegrill</h2>
                    <div class="f1-steps">
                    ...
                    <fieldset>
                        <div class="form-group"><label for="nama" style="font-size: 17px;font-weight: 800;color: #333333;">1. Nama</label>
                    ...
                    <fieldset>
                        ...
                        <div class="row">
                            <div class="col-xs-6" style="text-align: right;"><label>Kuantiti Livegrill</label></div>
                        ...
                        <div class="col-xs-12" style="margin-top: 24px">
                            <h4 class="text-center">Butiran</h4>
                        </div>
                        <div class="row">
                            <div class="col-xs-6" style="text-align: right;"><label>Nama</label></div>
                            <div class="col-xs-6"><p id="butirNama">-</p></div>
                        </div>
                        <div class="row">
                            <div class="col-xs-6" style="text-align: right;"><label>Email</label></div>
                            <div class="col-xs-6"><p id="butirEmail">-</p></div>
                        </div>
                        <div class="row">
                            <div class="col-xs-6" style="text-align: right;"><label>No. Telefon</label></div>
                            <div class="col-xs-6"><p id="butirTelefon">-</p></div>
                        </div>
                        <div class="row">
                            <div class="col-xs-6" style="text-align: right;"><label>Alamat</label></div>
                            <div class="col-xs-6"><p id="butirAlamat">-</p></div>
                        </div>
                        <div class="row">
                            <div class="col-xs-6" style="text-align: right;"><label>Dari Mana Tahu theaqiqah</label></div>
                            <div class="col-xs-6"><p id="dariMana">-</p></div>
                        </div>
                        ...
                        <div class="f1-buttons">
                            <button type="button" class="btn btn-previous">Kembali</button>
                            <button type="submit" class="btn btn-submit">Buat Bayaran</button>
                        </div>
                    </fieldset>
                </form>
            </div>
...
<script>
    ...
    $(document).ready(function(){
        ...
        var telefon = $('#telefon');
        var alamat = $('#alamat');
        var dariMana = $('#dari-mana');
        var alamatPenghantaran = $('#alamat-penghantaran');
        var tarikhPenghantaran = $('#tarikh-penghantaran');

        nama.change(function () {
            $('#butirNama').text($(this).val());
        });

        email.change(function () {
            $('#butirEmail').text($(this).val());
        });

        telefon.change(function () {
            $('#butirTelefon').text($(this).val());
        });

        alamat.change(function () {
            $('#butirAlamat').text($(this).val());
        });

        dariMana.change(function () {
            $('#dariMana').text($(this).val());
        });
